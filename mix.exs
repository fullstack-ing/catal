...
defmodule Catal.New.MixProject do
  use Mix.Project

  @version "0.1.0"
  @scm_url "https://github.com/fullstacking/catal"
  ...
  def project do
    [
      ...
      description: """
      Catal is a barebones Phoenix framework project generator.

      Provides a `mix catal.new` task to bootstrap a new Elixir application
      with minimal Phoenix dependencies.
      """
    ]
  end
