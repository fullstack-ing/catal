defmodule Catal.New.Single do
  @moduledoc false
  use Catal.New.Generator
  alias Catal.New.{Project}
  ...
  template(:html, [
    {:eex, :web,
     ...
     "phx_web/components/layouts/site_header.html.heex":
       "lib/:lib_web_name/components/layouts/site_header.html.heex",
     "phx_web/components/layouts/site_footer.html.heex":
       "lib/:lib_web_name/components/layouts/site_footer.html.heex",
  ...
  template(:css, [
    {:eex, :web,
     ...
     "phx_assets/css/core.css": "assets/css/core.css",
     "phx_assets/css/layers.css": "assets/css/layers.css",
     "phx_assets/css/layout.css": "assets/css/layout.css",
     "phx_assets/css/palette.css": "assets/css/palette.css",
     "phx_assets/css/reset.css": "assets/css/reset.css",
     "phx_assets/css/utilities.css": "assets/css/utilities.css"}
  ])

  template(:js, [
    {:eex, :web,
     "phx_assets/app.js": "assets/js/app.js", "phx_assets/package.json": "assets/package.json"}
  ])
